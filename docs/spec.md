# Flowix — ТЗ и спецификация проекта (архив AGENTS.md)

> **Примечание:** этот документ — полный перенос исходного `AGENTS.md` от 2026-08-22. Актуальные гайдлайны для ИИ-агентов — в корневом `AGENTS.md:1` (принципы Karpathy). Сюда ходи за логикой проекта, стеком и контрактами.
