...
> План: `docs/PLAN.md` | ТЗ: `docs/spec.md:1` | Сервисы и пайплайн: `docs/services-pipeline.md:1` | Гайдлайны: `AGENTS.md:1`
...
См. `docs/PLAN.md` — 8 фаз, `docs/spec.md:1` — полный архив ТЗ (бывший `AGENTS.md`), `docs/services-pipeline.md:1` — сервисы и пайплайн на русском. Zed настройки: `.zed/settings.json:1`, `docs/ZED.md:1`. Гайдлайны для ИИ — `AGENTS.md:1` из [multica-ai/andrej-karpathy-skills](https://github.com/multica-ai/andrej-karpathy-skills).
